                        ...
                        <ul>
                            <li class="active open">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="sidebar-light.html">Sidebar Light</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="#">
            ...
            <section class="page--header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-6">
                            <!-- Page Title Start -->
                            <h2 class="page--title h5">Sidebar Light</h2>
                            <!-- Page Title End -->

                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                                <li class="breadcrumb-item"><span>Page Layouts</span></li>
                                <li class="breadcrumb-item active"><span>Sidebar Light</span></li>
                            </ul>
                        </div>
