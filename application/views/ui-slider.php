                        ...
                        <ul>
                            <li class="active open">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="ui-slider.html">UI Slider</a></li>
            ...
            <section class="page--header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-6">
                            <!-- Page Title Start -->
                            <h2 class="page--title h5">UI Slider</h2>
                            <!-- Page Title End -->

                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                                <li class="breadcrumb-item"><span>UI Elements</span></li>
                                <li class="breadcrumb-item active"><span>UI Slider</span></li>
                            </ul>
                        </div>
            ...
            <section class="main--content">
                <div class="panel">
                    ...
                    <div class="panel-content py-5">
                        ...
                        <!-- Range Slider Start -->
                        <form action="#" class="mb-5 pb-4">
                            <input type="text" name="example" value="" data-trigger="range-slider" data-min="100" data-max="1000" data-from="200">
                        </form>
                        <!-- Range Slider End -->
                        ...
                        <!-- Range Slider Start -->
                        <form action="#" class="mb-5 pb-4">
                            <input type="text" name="example" value="" data-trigger="range-slider" data-prefix="$" data-min="100" data-max="1000" data-from="400" data-to="600" data-type="double" data-grid="true" data-grid-num="10">
                        </form>
                        <!-- Range Slider End -->

                        <p>Range With Negative Values</p>

                        <!-- Range Slider Start -->
                        <form action="#" class="mb-5 pb-4">
                            <input type="text" name="example" value="" data-trigger="range-slider" data-prefix="$" data-min="-1000" data-max="1000" data-from="-500" data-to="500" data-type="double" data-grid="true" data-grid-num="10">
                        </form>
                        <!-- Range Slider End -->

                        <p>Success Variation</p>

                        <!-- Range Slider Start -->
                        <form action="#" class="mb-5 pb-4">
                            <input type="text" name="example" value="" data-trigger="range-slider" data-min="100" data-max="1000" data-from="200" data-extra-classes="success">
                        </form>
                        <!-- Range Slider End -->
                        ...
                        <!-- Range Slider Start -->
                        <form action="#" class="mb-5 pb-4">
                            <input type="text" name="example" value="" data-trigger="range-slider" data-min="100" data-max="1000" data-from="200" data-extra-classes="info">
                        </form>
                        <!-- Range Slider End -->

                        <p>Warning Variation</p>

                        <!-- Range Slider Start -->
                        <form action="#" class="mb-5 pb-4">
                            <input type="text" name="example" value="" data-trigger="range-slider" data-min="100" data-max="1000" data-from="200" data-extra-classes="warning">
                        </form>
                        <!-- Range Slider End -->

                        <p>Danger Variation</p>

                        <!-- Range Slider Start -->
                        <form action="#">
                            <input type="text" name="example" value="" data-trigger="range-slider" data-min="100" data-max="1000" data-from="200" data-extra-classes="danger">
                        </form>
                        <!-- Range Slider End -->
                    </div>
                </div>
