                        ...
                        <ul>
                            <li class="active open">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="tabs-accordions.html">Tabs &amp; Accordions</a></li>
            ...
            <section class="page--header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-6">
                            <!-- Page Title Start -->
                            <h2 class="page--title h5">Tabs &amp; Accordions</h2>
                            <!-- Page Title End -->

                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                                <li class="breadcrumb-item"><span>UI Elements</span></li>
                                <li class="breadcrumb-item active"><span>Tabs &amp; Accordions</span></li>
                            </ul>
                        </div>
                ...
                <div class="row gutter-20">
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-content">
                                <div class="panel-subtitle">
                                    <h5 class="h5">Tab Style 1 <small>(Default)</small></h5>
                                </div>

                                <!-- Tabs Nav Start -->
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a href="#tab01" data-toggle="tab" class="nav-link active">Home</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#tab02" data-toggle="tab" class="nav-link">Details</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#tab03" data-toggle="tab" class="nav-link">More</a>
                                    </li>
                                </ul>
                                <!-- Tabs Nav End -->
                                ...
                                <div class="panel-subtitle">
                                    <h5 class="h5">Tab Style 2</h5>
                                </div>

                                <div class="row flex-nowrap mx-0">
                                    <!-- Tabs Nav Start -->
                                    <ul class="nav nav-tabs nav-tabs-left flex-column">
                                        <li class="nav-item">
                                            <a href="#tab04" data-toggle="tab" class="nav-link active">Home</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#tab05" data-toggle="tab" class="nav-link">Details</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#tab06" data-toggle="tab" class="nav-link">More</a>
                                        </li>
                                    </ul>
                                    <!-- Tabs Nav End -->
                                    ...
                                    <div class="tab-content col">
                                        <!-- Tab Pane Start -->
                                        <div class="tab-pane fade show active" id="tab04">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nihil ex quas, nostrum. Officia suscipit possimus inventore adipisci corporis?</p>
                                ...
                                <div class="panel-subtitle">
                                    <h5 class="h5">Tab Style 3</h5>
                                </div>

                                <!-- Tabs Nav Start -->
                                <ul class="nav nav-tabs nav-tabs-line">
                                    <li class="nav-item">
                                        <a href="#tab07" data-toggle="tab" class="nav-link active">Home</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="panel-subtitle">
                                    <h5 class="h5">Tab Style 4</h5>
                                </div>

                                <!-- Tabs Nav Start -->
                                <ul class="nav nav-tabs nav-tabs-line-top">
                                    <li class="nav-item">
                                        <a href="#tab10" data-toggle="tab" class="nav-link active">Home</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#tab11" data-toggle="tab" class="nav-link">Details</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#tab12" data-toggle="tab" class="nav-link">More</a>
                                    </li>
                                </ul>
                                <!-- Tabs Nav End -->
                                ...
                                <div class="row flex-nowrap mx-0">
                                    ...
                                    <ul class="nav nav-tabs nav-tabs-line-left flex-column">
                                        <li class="nav-item">
                                            <a href="#tab13" data-toggle="tab" class="nav-link active">Home</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#tab14" data-toggle="tab" class="nav-link">Details</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#tab15" data-toggle="tab" class="nav-link">More</a>
                                        </li>
                                    </ul>
                                    <!-- Tabs Nav End -->
                    ...
                    <div class="col-lg-6">
                        <div class="panel">
                            ...
                            <div class="panel-content">
                                <div class="panel-subtitle">
                                    <h5 class="h5">Collapse with icons</h5>
                                </div>
                                ...
                                <div id="accordion01">
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <h5 class="h5">
                                                <button class="btn btn-link collapse-icon" data-toggle="collapse" data-target="#collapse01">Collapse Group Item #1</button>
                                            </h5>
                                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <h5 class="h5">
                                                <button class="btn btn-link collapse-icon collapsed" data-toggle="collapse" data-target="#collapse02">Collapse Group Item #2</button>
                                            </h5>
                                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <h5 class="h5">
                                                <button class="btn btn-link collapse-icon collapsed" data-toggle="collapse" data-target="#collapse03">Collapse Group Item #3</button>
                                            </h5>
                                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <h5 class="h5">
                                                <button class="btn btn-link collapse-icon collapsed" data-toggle="collapse" data-target="#collapse04">Collapse Group Item #4</button>
                                            </h5>
                                        </div>
                                ...
                                <div id="accordion02">
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <h5 class="h5">
                                                <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse07">Collapse Group Item #7</button>
                                            </h5>
                                        </div>

                                        <div id="collapse07" class="collapse" data-parent="#accordion02">
                                            <div class="card-body">
                                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nihil ex quas, nostrum. Officia suscipit possimus inventore adipisci corporis?</p>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <h5 class="h5">
                                                <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse08">Collapse Group Item #8</button>
                                            </h5>
                                        </div>

                                        <div id="collapse08" class="collapse" data-parent="#accordion02">
                                            <div class="card-body">
                                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nihil ex quas, nostrum. Officia suscipit possimus inventore adipisci corporis?</p>
                                ...
                                <div class="panel-subtitle">
                                    <h5 class="h5">Toggle with icons</h5>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="h5">
                                            <button class="btn btn-link collapse-icon" data-toggle="collapse" data-target="#toggle_1">Toggle Item</button>
                                        </h5>
                                    </div>

                                    <div id="toggle_1" class="collapse show" data-parent="#accordion03">
                                        <div class="card-body">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nihil ex quas, nostrum. Officia suscipit possimus inventore adipisci corporis?</p>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="h5">
                                            <button class="btn btn-link collapse-icon collapsed" data-toggle="collapse" data-target="#toggle_2">Toggle Item</button>
                                        </h5>
                                    </div>

                                    <div id="toggle_2" class="collapse">
                                        <div class="card-body">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nihil ex quas, nostrum. Officia suscipit possimus inventore adipisci corporis?</p>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="h5">
                                            <button class="btn btn-link collapse-icon collapsed" data-toggle="collapse" data-target="#toggle_3">Toggle Item</button>
                                        </h5>
                                    </div>

                                    <div id="toggle_3" class="collapse">
                                        <div class="card-body">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nihil ex quas, nostrum. Officia suscipit possimus inventore adipisci corporis?</p>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="h5">
                                            <button class="btn btn-link collapse-icon collapsed" data-toggle="collapse" data-target="#toggle_4">Toggle Item</button>
                                        </h5>
                                    </div>

                                    <div id="toggle_4" class="collapse">
                                        <div class="card-body">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nihil ex quas, nostrum. Officia suscipit possimus inventore adipisci corporis?</p>
                                ...
                                <div class="panel-subtitle">
                                    <h5 class="h5">Toggle without icons</h5>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="h5">
                                            <button class="btn btn-link" data-toggle="collapse" data-target="#toggle_5">Toggle Item</button>
                                        </h5>
                                    </div>

                                    <div id="toggle_5" class="collapse show">
                                        <div class="card-body">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nihil ex quas, nostrum. Officia suscipit possimus inventore adipisci corporis?</p>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="h5">
                                            <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#toggle_6">Toggle Item</button>
                                        </h5>
                                    </div>

                                    <div id="toggle_6" class="collapse">
                                        <div class="card-body">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nihil ex quas, nostrum. Officia suscipit possimus inventore adipisci corporis?</p>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="h5">
                                            <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#toggle_7">Toggle Item</button>
                                        </h5>
                                    </div>

                                    <div id="toggle_7" class="collapse">
                                        <div class="card-body">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nihil ex quas, nostrum. Officia suscipit possimus inventore adipisci corporis?</p>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="h5">
                                            <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#toggle_8">Toggle Item</button>
                                        </h5>
                                    </div>

                                    <div id="toggle_8" class="collapse">
                                        <div class="card-body">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nihil ex quas, nostrum. Officia suscipit possimus inventore adipisci corporis?</p>
