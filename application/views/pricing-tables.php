                ...
                <div class="panel">
                    ...
                    <div class="panel-content">
                        <div class="panel-subtitle text-center text-md-left">
                            <h5 class="h5">Pricing Style 1</h5>
                        </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-3 col-md-6">
                                ...
                                <div class="pricing--item text-center mb-4">
                                    ...
                                    <div class="pricing--title pricing--title--box text-white bg-green">
                                        <p><strong><sup>$</sup>21</strong>/mo</p>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-6">
                                ...
                                <div class="pricing--item text-center mb-4">
                                    ...
                                    <div class="pricing--title pricing--title--box text-white bg-green">
                                        <p><strong><sup>$</sup>41</strong>/mo</p>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-6">
                                ...
                                <div class="pricing--item text-center mb-4 active">
                                    <span class="pricing--text text-white bg-orange">Best Value</span>
                                    ...
                                    <div class="pricing--title pricing--title--box text-white bg-green">
                                        <p><strong><sup>$</sup>61</strong>/mo</p>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-6">
                                ...
                                <div class="pricing--item text-center mb-4">
                                    ...
                                    <div class="pricing--title pricing--title--box text-white bg-green">
                                        <p><strong><sup>$</sup>81</strong>/mo</p>
                                    </div>
                        ...
                        <div class="panel-subtitle text-center text-md-left">
                            <h5 class="h5">Pricing Style 2</h5>
                        </div>

                        <div class="row align-items-center">
                            <div class="col-lg-3 col-md-6">
                                <!-- Pricing Item Start -->
                                <div class="pricing--item text-center mb-4 px-0">
                                    <div class="pricing--header text-white bg-green text-uppercase">
                                        <h3 class="h3">Basic</h3>
                                    </div>

                                    <div class="pricing--title text-white bg-green">
                                        <p><strong><sup>$</sup>21</strong>/mo</p>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <!-- Pricing Item Start -->
                                <div class="pricing--item text-center mb-4 px-0 active">
                                    <span class="pricing--text text-white bg-orange">Best Value</span>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <!-- Pricing Item Start -->
                                <div class="pricing--item text-center px-0 mb-4">
                                    <div class="pricing--header text-white bg-green text-uppercase">
                                        <h3 class="h3">Business</h3>
                                    </div>
                        ...
                        <div class="panel-subtitle text-center text-md-left">
                            <h5 class="h5">Pricing Style 3</h5>
                        </div>

                        <div class="row align-items-center">
                            <div class="col-lg-3 col-md-6">
                                <!-- Pricing Item Start -->
                                <div class="pricing--item text-center text-white bg-green mb-4">
