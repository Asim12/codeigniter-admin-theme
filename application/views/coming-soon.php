...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="m-comingsoon-w" data-bg-img="<?php echo SURL;?>assets/img/account/wrapper-bg.jpg" data-overlay="0.5">
            <div class="m-comingsoon">
                <div class="m-comingsoon--header">
                    <!-- Logo Start -->
                    <div class="logo">
                        <img src="<?php echo SURL;?>assets/img/logo-white.png" alt="">
                    </div>
                    <!-- Logo End -->

                    <h2 class="h2">Before Launching Our</h2>
                    <h2 class="h1">New Website</h2>

                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Labore, cupiditate distinctio cum nobis magnam quis assumenda eveniet ut ab, nisi modi!</p>
                </div>

                <div class="m-comingsoon--body">
                    <div class="m-comingsoon--countdown">
                        <ul class="countdown" data-countdown-to="2018/12/31"></ul>
                    </div>

                    <div class="m-comingsoon--subscribe">
                        <form action="#" method="post">
                            <input type="email" name="email" placeholder="Type your email to subscribe..." class="form-control" required>
    ...
    <!-- Page Level Scripts -->
    <script src="<?php echo SURL;?>assets/js/jquery.countdown.min.js"></script>
    <script src="<?php echo SURL;?>assets/js/jquery.countdown-init.js"></script>
