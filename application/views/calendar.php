...
<body>
            ...
            <section class="page--header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-6">
                            <!-- Page Title Start -->
                            <h2 class="page--title h5">Calendar</h2>
                            <!-- Page Title End -->
    ...
    <script src="<?php echo SURL;?>assets/js/fullcalendar.min.js"></script>
    <script src="<?php echo SURL;?>assets/js/page/calendar.js"></script>
