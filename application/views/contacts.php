                                ...
                                <ul class="user--list">
                                    <li>
                                        <a href="#" class="list-link">
                                            <div class="avatar">
                                                <img src="<?php echo SURL;?>assets/img/avatars/01_80x80.png" alt="">
                                            </div>
                                    ...
                                    <li>
                                        <a href="#" class="list-link">
                                            <div class="avatar">
                                                <img src="<?php echo SURL;?>assets/img/avatars/02_80x80.png" alt="">
                                            </div>
                                    ...
                                    <li class="active">
                                        <a href="#" class="list-link">
                                            <div class="avatar">
                                                <img src="<?php echo SURL;?>assets/img/avatars/03_80x80.png" alt="">
                                            </div>
                                    ...
                                    <li>
                                        <a href="#" class="list-link">
                                            <div class="avatar">
                                                <img src="<?php echo SURL;?>assets/img/avatars/04_80x80.png" alt="">
                                            </div>
                        ...
                        <div class="app_content col-lg-6">
                            ...
                            <div class="contact--view">
                                <div class="contact--view__avatar">
                                    <img src="<?php echo SURL;?>assets/img/avatars/03_150x150.png" alt="">
                                </div>
