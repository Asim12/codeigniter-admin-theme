                        ...
                        <ul>
                            <li class="active open">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="progress-bars.html">Progress Bars</a></li>
            ...
            <section class="page--header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-6">
                            <!-- Page Title Start -->
                            <h2 class="page--title h5">Progress Bars</h2>
                            <!-- Page Title End -->

                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                                <li class="breadcrumb-item"><span>UI Elements</span></li>
                                <li class="breadcrumb-item active"><span>Progress Bars</span></li>
                            </ul>
                        </div>
                    ...
                    <div class="panel-content py-5">
                        <div class="row mb-4">
                            <div class="col-md-4 mb-5">
                                <h5 class="h5 fw--600 mb-3">Default Progress Bar</h5>
                            ...
                            <div class="col-md-4 mb-5">
                                <h5 class="h5 fw--600 mb-3">Progress Bar Labels</h5>

                                <div class="progress h-15px">
                                    <div class="progress-bar bg-green w-75">75%</div>
                                </div>
                            </div>

                            <div class="col-md-4 mb-5">
                                <h5 class="h5 fw--600 mb-3">Progress Bar Striped</h5>

                                <div class="progress h-15px">
                                    <div class="progress-bar progress-bar-striped bg-info w-75"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-4 mb-5">
                                <h5 class="h5 fw--600 mb-3">Colored Progress Bars</h5>
                                ...
                                <div class="progress">
                                    <div class="progress-bar bg-green w-25"></div>
                                </div>
                            ...
                            <div class="col-md-4 mb-5">
                                <h5 class="h5 fw--600 mb-3">Progress Bar Sizes</h5>
                            ...
                            <div class="col-md-4 mb-5">
                                <h5 class="h5 fw--600 mb-3">Animated Stripe Progress Bar</h5>

                                <div class="progress h-15px">
                                    <div class="progress-bar progress-bar-striped progress-bar-animated bg-orange w-75"></div>
                                </div>
                                ...
                                <div class="progress h-15px">
                                    <div class="progress-bar progress-bar-striped progress-bar-animated bg-red w-50"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-3 mb-5">
                                <h5 class="h5 fw--600 mb-3">Vertical Progress Bars</h5>

                                <div class="progress vertical-progress">
                                    <div class="progress-bar bg-red h-75"></div>
                                </div>

                                <div class="progress vertical-progress">
                                    <div class="progress-bar bg-dark h-50"></div>
                                </div>

                                <div class="progress vertical-progress">
                                    <div class="progress-bar bg-info h-25"></div>
                                </div>

                                <div class="progress vertical-progress">
                                    <div class="progress-bar bg-orange h-25"></div>
                                </div>

                                <div class="progress vertical-progress">
                                    <div class="progress-bar bg-success h-50"></div>
                                </div>
                            </div>

                            <div class="col-md-3 mb-5">
                                <h5 class="h5 fw--600 mb-3">From Bottom</h5>

                                <div class="progress vertical-progress-bottom">
                                    <div class="progress-bar bg-red h-75"></div>
                                </div>
                            ...
                            <div class="col-md-3 mb-5">
                                <h5 class="h5 fw--600 mb-3">Different Sizes</h5>

                                <div class="progress vertical-progress-bottom">
                                    <div class="progress-bar bg-red h-75"></div>
                                </div>

                                <div class="progress vertical-progress-bottom w-8px">
                                    <div class="progress-bar bg-dark h-50"></div>
                                </div>

                                <div class="progress vertical-progress-bottom w-10px">
                                    <div class="progress-bar bg-info h-25"></div>
                                </div>

                                <div class="progress vertical-progress-bottom w-12px">
                                    <div class="progress-bar bg-orange h-25"></div>
                                </div>

                                <div class="progress vertical-progress-bottom w-15px">
                                    <div class="progress-bar bg-success h-50"></div>
                                </div>
                            </div>

                            <div class="col-md-3 mb-5">
                                <h5 class="h5 fw--600 mb-3">Striped Bars</h5>

                                <div class="progress vertical-progress-bottom w-15px">
                                    <div class="progress-bar progress-bar-striped progress-bar-animated bg-red h-75"></div>
                                </div>

                                <div class="progress vertical-progress-bottom w-15px">
                                    <div class="progress-bar progress-bar-striped progress-bar-animated bg-dark h-50"></div>
                                </div>

                                <div class="progress vertical-progress-bottom w-15px">
                                    <div class="progress-bar progress-bar-striped progress-bar-animated bg-info h-25"></div>
                                </div>

                                <div class="progress vertical-progress-bottom w-15px">
                                    <div class="progress-bar progress-bar-striped progress-bar-animated bg-orange h-25"></div>
                                </div>

                                <div class="progress vertical-progress-bottom w-15px">
                                    <div class="progress-bar progress-bar-striped progress-bar-animated bg-success h-50"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <h5 class="h5 fw--600 mb-3">Text Progress Bars</h5>

                                <h6 class="h5 mb-2">Photoshop <span class="float-right">75%</span></h6>
                                <div class="progress">
                                    <div class="progress-bar bg-orange w-75"></div>
                                </div>

                                <h6 class="h5 mt-3 mb-2">Illustrator <span class="float-right">50%</span></h6>
                                <div class="progress">
                                    <div class="progress-bar bg-info w-50"></div>
                                </div>

                                <h6 class="h5 mt-3 mb-2">Sketch <span class="float-right">75%</span></h6>
                                <div class="progress">
