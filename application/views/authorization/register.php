...
<body>
    ...
    <div class="wrapper">
        <!-- Register Page Start -->
        <div class="m-account-w" data-bg-img="<?php echo SURL;?>assets/img/account/wrapper-bg.jpg">
            <div class="m-account">
                <div class="row no-gutters flex-row-reverse">
                    <div class="col-md-6">
                        <!-- Register Content Start -->
                        <div class="m-account--content-w" data-bg-img="<?php echo SURL;?>assets/img/account/content-bg.jpg">
