...
<body>
            ...
            <section class="page--header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-6">
                            <!-- Page Title Start -->
                            <h2 class="page--title h5">Notes</h2>
                            <!-- Page Title End -->

                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                                <li class="breadcrumb-item active"><span>Notes</span></li>
                            </ul>
                        </div>
                ...
                <div class="panel">
                    ...
                    <div class="app_wrapper row">
                        ...
                        <div class="app_sidebar col-lg-3">
                            <!-- Toolbar Start -->
                            <div class="toolbar">
                                <h4 class="toolbar__title"><i class="fa fa-sticky-note"></i>Notes</h4>

                                <a href="#" class="btn btn-rounded btn-warning fw--600 ml-auto">New</a>
                            </div>
                            <!-- Toolbar End -->

                            <!-- App Search Bar Start -->
                            <form action="#" method="get" class="app_searchBar mb-3 pb-3">
                                <input type="search" name="notes" placeholder="Search Notes..." class="form-control" required>
                            ...
                            <ul class="note--list">
                                <li class="active">
                                    <a href="#" class="view-item border-blue" data-value="blue">
                                        <h4 class="title">New Note</h4>
                                        <span class="date">Feb 14, 2018 19:48</span>
                                    </a>

                                    <a href="#" class="remove-item fa fa-times"></a>
                                </li>
                                <li>
                                    <a href="#" class="view-item border-green" data-value="green">
                                        <h4 class="title">This is a simple note.</h4>
                                ...
                                <li>
                                    <a href="#" class="view-item border-orange" data-value="orange">
                                        <h4 class="title">This is a simple note.</h4>
                                        <span class="desc">Lorem ipsum dolor sit amet!</span>
                                        <span class="date">Feb 14, 2018 19:48</span>
                                    </a>
                                ...
                                <li>
                                    <a href="#" class="view-item border-red" data-value="red">
                                        <h4 class="title">This is a simple note.</h4>
                                        <span class="desc">Lorem ipsum dolor sit amet!</span>
                                        <span class="date">Feb 14, 2018 19:48</span>
                                    </a>
                        ...
                        <div class="app_content col-lg-9">
                            <!-- Toolbar Start -->
                            <div class="toolbar">
                                <p class="toolbar__desc">Created On: <span>Feb 14, 2018 19:48</span></p>

                                <!-- Note Label Start -->
                                <div class="note--label dropdown">
                                    <span class="dropdown-toggle bg-blue" data-value="blue" data-toggle="dropdown"></span>

                                    <ul class="dropdown-menu dropdown-menu-center">
                                        <li class="bg-blue" data-value="blue"></li>
                                        <li class="bg-green" data-value="green"></li>
                                        <li class="bg-orange" data-value="orange"></li>
                                        <li class="bg-red" data-value="red"></li>
                                    </ul>
                                </div>
                                <!-- Note Label End -->
                            </div>
    ...
    <!-- Page Level Scripts -->
    <script src="<?php echo SURL;?>assets/js/page/notes.js"></script>
